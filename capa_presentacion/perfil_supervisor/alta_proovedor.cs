...
namespace capa_presentacion.perfil_supervisor
{
    public partial class alta_proovedor : Form
    {
        ...
        private void btnGuardarProveedor_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtCuit.Text) || string.IsNullOrWhiteSpace(txtRubro.Text) || string.IsNullOrWhiteSpace(txtDireccion.Text) || string.IsNullOrWhiteSpace(txtRazonSocial.Text))
            {
